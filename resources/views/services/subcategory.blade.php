                ...
                <div class="col-lg-12">
                    ...
                    @if(!empty($faqs))
                        <div class="page-single-faqs">
                            ...
                            <div class="faq-accordion" id="faq-accordion-subcategory">
                                @foreach($faqs as $index => $item)
                                    @php
                                        $collapseId = 'faq-subcategory-collapse-' . $index;
                                        $headingId = 'faq-subcategory-heading-' . $index;
                                    @endphp
                                    <div class="accordion-item wow fadeInUp">
                                        ...
                                        <div id="{{ $collapseId }}" class="accordion-collapse collapse" role="region" aria-labelledby="{{ $headingId }}" data-bs-parent="#faq-accordion-subcategory">
